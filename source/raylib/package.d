...
*
**********************************************************************************************/
// This version of Raylib has been altered from the original.
...
// NOTE: These identifiers are specific to Raylib-D. The equivalent enum in standard Raylib is called
// `KeyboardKey`, and all values are prefixed with `KEY_`. This version is also available here as they
// are generated by the `EnumPrefixes` function.
enum Key
{
...
enum GamepadButton
{
    ...
    FACE_LEFT = 8,
    GAMEPAD_BUTTON_LEFT_TRIGGER_1 = 9, // Gamepad top/back shoulder/trigger left (first), it could be a trailing button
    LEFT_SHOULDER = 9,
    SHOULDER_LEFT = 9,
    GAMEPAD_BUTTON_LEFT_TRIGGER_2 = 10, // Gamepad top/back shoulder/trigger left (second), it could be a trailing button
    LEFT_TRIGGER = 10,
    TRIGGER_LEFT = 10,
    GAMEPAD_BUTTON_RIGHT_TRIGGER_1 = 11, // Gamepad top/back shoulder/trigger right (one), it could be a trailing button
    RIGHT_SHOULDER = 11,
    SHOULDER_RIGHT = 11,
    GAMEPAD_BUTTON_RIGHT_TRIGGER_2 = 12, // Gamepad top/back shoulder/trigger right (second), it could be a trailing button
    RIGHT_TRIGGER = 12,
    TRIGGER_RIGHT = 12,
...
enum BlendMode
{
    BLENDMODE_BLEND_ALPHA = 0, // Blend textures considering alpha (default)
    BLEND_ALPHA = 0,
    BLENDMODE_BLEND_ADDITIVE = 1, // Blend textures adding colors
    BLEND_ADDITIVE = 1,
    BLENDMODE_BLEND_MULTIPLIED = 2, // Blend textures multiplying colors
    BLEND_MULTIPLIED = 2,
    BLENDMODE_BLEND_ADD_COLORS = 3, // Blend textures adding colors (alternative)
    BLEND_ADD_COLORS = 3,
    BLENDMODE_BLEND_SUBTRACT_COLORS = 4, // Blend textures subtracting colors (alternative)
    BLEND_SUBTRACT_COLORS = 4,
    BLENDMODE_BLEND_ALPHA_PREMULTIPLY = 5, // Blend premultiplied textures considering alpha
    BLEND_ALPHA_PREMULTIPLY = 5,
    BLENDMODE_BLEND_CUSTOM = 6, // Blend textures using custom src/dst factors (use rlSetBlendFactors())
    BLEND_CUSTOM = 6,
    BLENDMODE_BLEND_CUSTOM_SEPARATE = 7, // Blend textures using custom rgb/alpha separate src/dst factors (use rlSetBlendFactorsSeparate())
